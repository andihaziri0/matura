...
export const sq = {
  ...
  practice: {
    ...
    bankImagesOnlyHint:
      'Skanimi i plotë i faqës (si në foton e celularit), jo thjesht figura gjeometrike brenda pyetjes.',
    ...
    galleryTitle: 'Skanime nga pyetjet',
    gallerySubtitle: 'Faqet e provimit si foto (jo vetëm figura në tekst).',
    scrollTop: 'Lart',
