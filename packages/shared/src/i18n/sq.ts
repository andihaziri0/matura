...
export const sq = {
  ...
  practice: {
    ...
    navNext: 'Tjetër',
    tabSession: 'Ushtrime (seancë)',
    tabBank: 'Banka pyetjesh',
    bankIntro:
      'Shfleto pyetje të publikuara, filtro sipas kapitullit dhe burimit — si banka e vjetër statike.',
    bankSearchPlaceholder: 'Kërko në pyetje (tekst ose etiketë)...',
    sourceAll: 'Të gjitha burimet',
    sourceFoto: 'Nga testet (foto / skan)',
    sourceGjeneruar: 'Gjeneruar (stërvitje)',
    loadMore: 'Ngarko më shumë',
    showAnswer: 'Shfaq përgjigjen',
    examMode: 'Modaliteti provim',
    examModeHint: 'Në bankë: nuk tregohet menjëherë nëse përgjigjja është e saktë. Në seancë: shpjegimi hapet me buton.',
    sessionSize: 'Sa pyetje në seancë',
    questionsCount10: '10 pyetje',
    questionsCount25: '25 pyetje (si testi i rastit)',
    sessionExamMode: 'Seancë në modalitet provim',
    revealResult: 'Shfaq vlerësimin dhe shpjegimin',
    galleryTitle: 'Figura nga pyetjet',
    gallerySubtitle: 'Imazhe të lidhura me pyetje të publikuara (miniatura).',
    scrollTop: 'Lart',
